...
import REBUILD_LOGO from '../../img/Rebuild_logo2.png';
import Back from '../../img/arrow_backBlack.png';
import Chat from '../../img/chat_bubbleBlack.png';
import Delete from '../../img/delete1.png';
...
const MOCK_COMMENTS: CommentData[] = [
    ...
    },
    {
        ...
        postId: 105,
        date: "2025.04.04",
        content: "저는 결국 포기했어요. 너무 지치더라고요. 다른 분들은 꼭 성공하시길 바랍니다. 이 댓글 보고 조금이라도 힘이 됐으면 좋겠어요. 길게 썼는데 짤릴까요?",
    },
    {
        id: 6,
        postId: 106,
        date: "2025.04.03",
        content: "혹시 글쓴이님 상황이랑 비슷한데 다른 결과 냈던 분 계신가요? 조언 부탁드립니다.",
    },
    {
        id: 7,
        postId: 107,
